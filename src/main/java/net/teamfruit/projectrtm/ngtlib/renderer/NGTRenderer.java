...
import net.teamfruit.projectrtm.ngtlib.world.IBlockAccessNGT;
import net.teamfruit.projectrtm.ngtlib.world.NGTBlockAccess;
...
public final class NGTRenderer {
	...
	public static void renderNGTObject(IBlockAccessNGT par1, NGTObject par2, boolean changeLightting, int mode, int pass) {
		GL11.glPushMatrix();
		if (changeLightting) {
			RenderHelper.disableStandardItemLighting();//これないと若干暗くなる
		}
