...
import net.teamfruit.projectrtm.ngtlib.item.ItemMultiIcon;
import net.teamfruit.projectrtm.rtm.item.ItemAmmunition;
import net.teamfruit.projectrtm.rtm.item.ItemBellows;
import net.teamfruit.projectrtm.rtm.item.ItemBogie;
import net.teamfruit.projectrtm.rtm.item.ItemBucketLiquid;
import net.teamfruit.projectrtm.rtm.item.ItemCargo;
import net.teamfruit.projectrtm.rtm.item.ItemCrowbar;
import net.teamfruit.projectrtm.rtm.item.ItemGun;
import net.teamfruit.projectrtm.rtm.item.ItemHacksaw;
import net.teamfruit.projectrtm.rtm.item.ItemInstalledObject;
import net.teamfruit.projectrtm.rtm.item.ItemLinePole;
import net.teamfruit.projectrtm.rtm.item.ItemMagazine;
import net.teamfruit.projectrtm.rtm.item.ItemMirror;
import net.teamfruit.projectrtm.rtm.item.ItemNPC;
import net.teamfruit.projectrtm.rtm.item.ItemNVD;
import net.teamfruit.projectrtm.rtm.item.ItemPaddle;
import net.teamfruit.projectrtm.rtm.item.ItemPaintTool;
import net.teamfruit.projectrtm.rtm.item.ItemPipe;
import net.teamfruit.projectrtm.rtm.item.ItemRail;
import net.teamfruit.projectrtm.rtm.item.ItemRailroadSign;
import net.teamfruit.projectrtm.rtm.item.ItemSignal;
import net.teamfruit.projectrtm.rtm.item.ItemTicket;
import net.teamfruit.projectrtm.rtm.item.ItemTrain;
import net.teamfruit.projectrtm.rtm.item.ItemVehicle;
import net.teamfruit.projectrtm.rtm.item.ItemWire;
...
public final class RTMItem {
	...
	private static Map<Integer, String> getItemMoney()//村人と交換?
	{
		Map<Integer, String> map = new HashMap<Integer, String>();
		for (int i = 0; i<9; ++i) {
			map.put(i, "rtm:money_"+i);
		}
		return map;
	}
