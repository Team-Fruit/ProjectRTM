...
import net.teamfruit.projectrtm.rtm.craft.RecipeManager;
import net.teamfruit.projectrtm.rtm.craft.RepairRecipe;
import net.teamfruit.projectrtm.rtm.craft.ShapedRecipes55;
...
public final class RTMRecipe {
	public static void init() {
		...
		ItemStack wire = new ItemStack(RTMItem.material, 1, 5);
