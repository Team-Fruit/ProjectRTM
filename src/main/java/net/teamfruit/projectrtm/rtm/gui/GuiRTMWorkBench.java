...
import net.teamfruit.projectrtm.ngtlib.gui.GuiContainerCustom;
...
public class GuiRTMWorkBench extends GuiContainerCustom implements IModelSelector {
	...
	private void sendRailProp() {
		...
		RTMCore.NETWORK_WRAPPER.sendToServer(new PacketNotice(PacketNotice.Side_SERVER, this.workBench.xCoord, this.workBench.yCoord, this.workBench.zCoord, s));
