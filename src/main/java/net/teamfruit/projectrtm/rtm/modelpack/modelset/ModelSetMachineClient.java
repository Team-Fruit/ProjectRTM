...
public class ModelSetMachineClient extends ModelSetMachine implements IModelSetClient {
	public final ModelObject modelObj;
	public final ResourceLocation buttonTexture;

	public ModelSetMachineClient() {
		super();
	...
	public ModelSetMachineClient(MachineConfig par1) {
		super(par1);
