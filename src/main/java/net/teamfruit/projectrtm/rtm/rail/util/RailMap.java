package net.teamfruit.projectrtm.rtm.rail.util;
...
import net.teamfruit.projectrtm.ngtlib.math.BezierCurve;
import net.teamfruit.projectrtm.ngtlib.math.ILine;
import net.teamfruit.projectrtm.ngtlib.math.NGTMath;
import net.teamfruit.projectrtm.ngtlib.math.StraightLine;
