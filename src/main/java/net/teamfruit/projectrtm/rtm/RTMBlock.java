...
import net.teamfruit.projectrtm.ngtlib.block.BlockDummy;
import net.teamfruit.projectrtm.ngtlib.item.ItemBlockCustom;
import net.teamfruit.projectrtm.ngtlib.util.NGTUtil;
import net.teamfruit.projectrtm.rtm.block.BlockBrickSlab;
import net.teamfruit.projectrtm.rtm.block.BlockConverter;
import net.teamfruit.projectrtm.rtm.block.BlockCrossingGate;
import net.teamfruit.projectrtm.rtm.block.BlockEffect;
import net.teamfruit.projectrtm.rtm.block.BlockFireBrick;
import net.teamfruit.projectrtm.rtm.block.BlockFlag;
import net.teamfruit.projectrtm.rtm.block.BlockFluorescent;
import net.teamfruit.projectrtm.rtm.block.BlockFurnaceFire;
import net.teamfruit.projectrtm.rtm.block.BlockIronPillar;
import net.teamfruit.projectrtm.rtm.block.BlockLight;
import net.teamfruit.projectrtm.rtm.block.BlockLinePole;
import net.teamfruit.projectrtm.rtm.block.BlockMeltedMetal;
import net.teamfruit.projectrtm.rtm.block.BlockMetalSlab;
import net.teamfruit.projectrtm.rtm.block.BlockMirror;
import net.teamfruit.projectrtm.rtm.block.BlockMovingMachine;
import net.teamfruit.projectrtm.rtm.block.BlockPaint;
import net.teamfruit.projectrtm.rtm.block.BlockPipe;
import net.teamfruit.projectrtm.rtm.block.BlockPoint;
import net.teamfruit.projectrtm.rtm.block.BlockRSWire;
import net.teamfruit.projectrtm.rtm.block.BlockRailroadSign;
import net.teamfruit.projectrtm.rtm.block.BlockScaffold;
import net.teamfruit.projectrtm.rtm.block.BlockScaffoldStairs;
import net.teamfruit.projectrtm.rtm.block.BlockSignBoard;
import net.teamfruit.projectrtm.rtm.block.BlockSlot;
import net.teamfruit.projectrtm.rtm.block.BlockStation;
import net.teamfruit.projectrtm.rtm.block.BlockTrainWorkBench;
import net.teamfruit.projectrtm.rtm.block.BlockTurnstile;
import net.teamfruit.projectrtm.rtm.block.BlockVariable;
...
import net.teamfruit.projectrtm.rtm.block.tileentity.TileEntityScaffold;
...
import net.teamfruit.projectrtm.rtm.block.tileentity.TileEntitySlot;
...
import net.teamfruit.projectrtm.rtm.electric.BlockConnector;
import net.teamfruit.projectrtm.rtm.electric.BlockInsulator;
import net.teamfruit.projectrtm.rtm.electric.BlockSignal;
import net.teamfruit.projectrtm.rtm.electric.BlockSignalConverter;
import net.teamfruit.projectrtm.rtm.electric.BlockTicketVendor;
...
import net.teamfruit.projectrtm.rtm.electric.TileEntitySignalConverter.TileEntitySC_Decrement;
import net.teamfruit.projectrtm.rtm.electric.TileEntitySignalConverter.TileEntitySC_Increment;
import net.teamfruit.projectrtm.rtm.electric.TileEntitySignalConverter.TileEntitySC_RSIn;
import net.teamfruit.projectrtm.rtm.electric.TileEntitySignalConverter.TileEntitySC_RSOut;
import net.teamfruit.projectrtm.rtm.electric.TileEntitySignalConverter.TileEntitySC_Wireless;
...
public final class RTMBlock {
	...
	public static void init() {
		...
		effect = (new BlockEffect()).setBlockName("rtm:effect").setBlockTextureName("rtm:effect");
